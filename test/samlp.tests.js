...
describe('samlp (functional tests)', function () {
  ...
  describe('samlp flow with tracked AuthnRequest ID', function () {
    var r, bod;
    ...
    it('should redirect to idp', function(done){
      expect(r.statusCode)
            .to.equal(302);
...
describe('samlp (unit tests)', function () {
  ...
  describe('validateResponse', function() {
    ...
    it('should return assertion with valid destination', function (done) {
      var options = {
      ...
      samlp.validateSamlResponse(samlpResponse, function (err, assertion) {
