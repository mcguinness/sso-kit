...
Samlp.prototype = {
  ...
  generateAuthnRequest: function (req, options) {
    ...
    if (!options.realm) {
      throw new Error('Unable to generate an AuthnRequest because a SAML Issuer URI is not specifed in options.realm');
    }
  ...
  generateLogoutRequest: function (req, options) {
    ...
    if (!options.realm) {
      throw new Error('Unable to generate an LogoutRequest because a SAML Issuer URI is not specifed in options.realm');
    }
